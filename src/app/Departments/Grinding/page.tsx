...
//       }
//     } catch (error) {
//       console.error('Error creating grinding:', error);
...
//         <div className="p-6">
//           <h2 className="text-xl font-semibold mb-6">Create Grinding from Department</h2>
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const requestData = {
      grindingId: filingId, // ✅ correct param for grinding endpoint
      issuedWeight: parseFloat(totalWeight.toFixed(4)),
      issuedDate: new Date().toISOString(),
      orderId: firstPouch?.orderId || null,
      name: firstPouch?.name || null,
    ...
    const response = await fetch(`${apiBaseUrl}/api/grinding-record/create`, {
      method: "POST",
