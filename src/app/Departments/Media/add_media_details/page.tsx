...
if (invalidPouch) {
  ...
  return;
    ...
    const response = await fetch(`${apiBaseUrl}/api/media/create`, {
      method: 'POST',
      headers: { 
      ...
      <div className="h-full overflow-y-auto p-4 pt-40 mt-[-30px] bg-gray-50">
        <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-sm p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg font-semibold">Add Media Details</h2>
          ...
          <div className="mb-6 p-4 bg-gray-50 rounded-lg">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="text-sm font-medium">
                MEDIA ID: <span className="text-blue-600 font-bold">
