...
//         toast.success('Correction record created successfully');
//         router.push('/Departments/Grinding');
//       } else {
//         throw new Error(result.message || 'Failed to create Correction record');
//       }
//     } catch (error) {
//       console.error('Error creating Correction:', error);
//       toast.error(error.message || 'Failed to create Correction record');
//     } finally {
//       setLoading(false);
//     }
//   };
...
//     // ✅ Build payload
//     const requestData = {
//       correctionId: filingId, // match backend param
//       issuedWeight: parseFloat(totalWeight.toFixed(4)),
//       issuedDate: new Date().toISOString(),
//       orderId: firstPouch?.orderId || null,
//       name: firstPouch?.name || null,
...
//     const response = await fetch(`${apiBaseUrl}/api/correction-record/create`, {
//       method: "POST",
...
//     if (result.success) {
//       toast.success("Correction record created successfully");
//       router.push("/Departments/Correction");
//     } else {
//       throw new Error(result.message || "Failed to create Correction record");
//     }
//   } catch (error: any) {
