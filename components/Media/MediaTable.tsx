                            ...
                            >
                              ...
                              <TableCell className="table__icon-box">
                                <div className="flex items-center justify-start gap-[10px]">
                                  <Link href={`/Departments/Media/show_media_details?grindingId=${deal.id}`} passHref style={{display:"none"}}>
                                    <button
                                      type="button"
                                  ...
                                  {deal.status?.toLowerCase() !== 'finished' ? (
                                    <Link href={`/Departments/Media/media_received_details?MediaId=${deal.id}`} passHref>
                                      <button
                                        type="button"
                                        className="table__icon edit"
                                        style={{
 ...
 <button disabled={deal.status?.trim().toLowerCase() === 'finished'}
                                  ...
                                  <Select disabled={deal.movedstatus === 1}
                                    onValueChange={(value) => {
                                      ...
                                      if (dept) {
                                        window.location.href = `${dept.path}?mediaID=${deal.id}`;
                                      }
                                    }}
                                  >
                                    <SelectTrigger 
